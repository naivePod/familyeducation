...
var app = {
    ...
    URL: {
        ...
        updateAuditUrl: function () {
            return app.data.contextPath+"/manage/audit/updateStatus"
        },
        manageAuditListUrl: function () {
            return app.data.contextPath+"/manage/audit/list"
        },
